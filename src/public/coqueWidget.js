...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box;-webkit-tap-highlight-color:transparent;min-width:0}html,body{margin:0;width:100%;max-width:100%;min-height:100%;overflow-x:hidden;background:radial-gradient(circle at top left,rgba(255,205,180,.7),transparent 34%),radial-gradient(circle at top right,rgba(191,223,255,.65),transparent 28%),radial-gradient(circle at bottom right,rgba(219,241,224,.75),transparent 34%),var(--bg);color:var(--text);font-family:'Space Grotesk',sans-serif}body{margin:0 auto}button,input,select{font:inherit}button{cursor:pointer}
    .app{width:100%;max-width:430px;margin:0 auto;min-height:100%;display:flex;flex-direction:column;gap:8px;padding:8px}.card{background:var(--panel);border:1px solid rgba(255,255,255,.55);border-radius:18px;box-shadow:0 10px 24px rgba(72,49,34,.12);backdrop-filter:blur(10px);overflow:hidden}.hero{padding:12px}.hero-top{display:grid;grid-template-columns:1fr auto;gap:10px;align-items:start}.eyebrow,.section{display:inline-flex;text-transform:uppercase;letter-spacing:.08em;font-size:9px;font-weight:700;color:var(--muted)}.eyebrow{padding:5px 8px;border-radius:999px;background:rgba(37,26,22,.06);margin-bottom:8px}h1{margin:0;font:22px/1.05 'Archivo Black',sans-serif;letter-spacing:0}.copy{margin-top:8px;font-size:12px;line-height:1.35;color:var(--muted);max-width:100%}
    .price{min-width:96px;padding:9px;border-radius:14px;background:linear-gradient(180deg,rgba(255,255,255,.95),rgba(244,235,225,.96));border:1px solid rgba(37,26,22,.08);text-align:right}.price-label{font-size:8px;text-transform:uppercase;letter-spacing:.08em;color:var(--muted)}.price-current{margin-top:5px;font-size:15px;font-weight:700;line-height:1}.price-old{margin-top:4px;font-size:10px;color:var(--muted);text-decoration:line-through}
    .config{margin-top:10px;padding-top:10px;border-top:1px solid var(--line)}.brand-strip,.tabs{display:flex;gap:6px;overflow-x:auto;overscroll-behavior-x:contain;padding:3px 1px 5px;scrollbar-width:none}.brand-strip::-webkit-scrollbar,.tabs::-webkit-scrollbar{display:none}.chip,.tab{flex:0 0 auto;border:1px solid var(--line);background:rgba(255,255,255,.86);color:var(--text);border-radius:999px;padding:8px 11px;white-space:nowrap;font-size:13px;font-weight:600}.chip.active,.tab.active{background:var(--text);color:#fff;border-color:transparent;box-shadow:0 8px 16px rgba(37,26,22,.14)}
    .picked,.search,.soft,.ghost{border:1px solid var(--line);background:rgba(255,255,255,.88);border-radius:12px;padding:10px 12px;color:var(--text)}.picked{margin-top:8px;font-size:12px;font-weight:600;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.search{width:100%;margin-top:7px;outline:none;font-size:14px}.search:focus{border-color:rgba(222,110,68,.45);box-shadow:0 0 0 3px rgba(222,110,68,.1)}.models{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px;max-height:112px;overflow:auto;margin-top:8px}.model{min-height:42px;text-align:left;border-radius:12px;background:rgba(255,255,255,.88);border:1px solid var(--line);padding:8px 10px;font-size:11px;font-weight:600;line-height:1.18;overflow:hidden}.model.active{background:linear-gradient(135deg,rgba(37,26,22,.95),rgba(89,58,43,.96));color:#fff;border-color:transparent}.empty{grid-column:1/-1;padding:14px 12px;border-radius:12px;background:rgba(255,255,255,.72);border:1px dashed rgba(37,26,22,.16);color:var(--muted);font-size:12px;text-align:center}
    .stage{min-height:0;padding:10px;display:grid;grid-template-rows:auto minmax(0,1fr);gap:8px}.stage-top{display:flex;justify-content:space-between;gap:8px;align-items:flex-start}.summary{display:flex;flex-direction:column;gap:3px}.summary strong{font-size:17px;line-height:1.18;overflow-wrap:anywhere}.summary span:last-child{font-size:12px;line-height:1.28;color:var(--muted);display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.origin{padding:8px 9px;border-radius:999px;background:rgba(25,121,77,.12);color:#176d48;font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;white-space:nowrap}.hide{display:none!important}
    .stage-body{min-height:0;display:grid;place-items:center;border-radius:16px;background:linear-gradient(180deg,rgba(255,255,255,.58),rgba(243,233,223,.76)),radial-gradient(circle at top,rgba(255,255,255,.7),transparent 56%);border:1px solid rgba(255,255,255,.55);padding:10px;position:relative;overflow:hidden}.phone{position:relative;width:min(58vw,185px);max-height:330px;aspect-ratio:1/2.02;border-radius:24px;overflow:hidden;background:#fff;box-shadow:0 12px 24px rgba(31,22,18,.16)}.phone:after{content:'';position:absolute;inset:0;border-radius:inherit;box-shadow:inset 0 0 0 1px rgba(20,16,14,.08);pointer-events:none;z-index:9}#design,#case{position:absolute;inset:0;width:100%;height:100%}#design{z-index:1;overflow:hidden;background-position:center;background-repeat:no-repeat;background-size:cover}#case{z-index:2;object-fit:cover;pointer-events:none}
    .helper{position:absolute;left:8px;right:8px;bottom:8px;z-index:10;padding:8px 10px;border-radius:12px;background:rgba(23,18,16,.82);color:#fff;font-size:10px;line-height:1.28;backdrop-filter:blur(8px);max-height:54px;overflow:hidden}.item{position:absolute;user-select:none;cursor:grab;touch-action:none}.item.sel{outline:2px dashed rgba(255,255,255,.94);box-shadow:0 0 0 2px rgba(12,10,9,.58)}.txt{z-index:5;white-space:nowrap;font-weight:700;line-height:1;text-shadow:0 2px 8px rgba(255,255,255,.28)}.img{z-index:4}
    .tools{padding:10px}.tools-head{display:flex;justify-content:space-between;gap:8px;align-items:flex-start;margin-bottom:8px}.tools-head strong{display:block;margin-top:3px;font-size:16px;line-height:1.15}.mini{font-size:10px;line-height:1.3;color:var(--muted);white-space:nowrap}.tool-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px}.tool{min-height:54px;border-radius:12px;border:1px solid var(--line);background:linear-gradient(180deg,rgba(255,255,255,.96),rgba(244,235,225,.98));padding:8px;text-align:left;color:var(--text);overflow:hidden}.tool b{display:block;font-size:8px;font-weight:700;text-transform:uppercase;letter-spacing:.08em;color:var(--muted)}.tool strong{display:block;margin-top:4px;font-size:13px;line-height:1.12;white-space:normal;overflow-wrap:anywhere}.rows{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:6px}.rows.mt{margin-top:8px}.cta{width:100%;margin-top:8px;border:none;border-radius:14px;padding:13px 14px;background:linear-gradient(135deg,var(--accent),var(--accent2));color:#fff;display:flex;align-items:center;justify-content:center;gap:10px;font-weight:700;box-shadow:0 12px 20px rgba(222,110,68,.28);font-size:15px}.spin{width:18px;height:18px;border-radius:50%;border:2px solid rgba(255,255,255,.36);border-top-color:#fff;animation:r .8s linear infinite;display:none}.loading .spin{display:inline-block}
    .layer{position:fixed;inset:0;display:none;z-index:40}.layer.on{display:block}.scrim{position:absolute;inset:0;background:rgba(17,13,11,.38);backdrop-filter:blur(8px)}.sheet{position:absolute;left:14px;right:14px;bottom:14px;max-height:calc(100vh - 52px);overflow:hidden;background:#fffdfa;border-radius:28px;box-shadow:0 28px 60px rgba(21,16,13,.24);display:grid;grid-template-rows:auto minmax(0,1fr)}#editorLayer{pointer-events:none}#editorLayer.on{display:block}#editorLayer .scrim{display:none}#editorLayer .sheet{pointer-events:auto;left:8px;right:8px;bottom:8px;border-radius:16px;background:rgba(255,253,250,.96);box-shadow:0 12px 28px rgba(21,16,13,.18);max-height:46vh}.head{display:flex;justify-content:space-between;gap:12px;align-items:flex-start;padding:16px 18px 12px;border-bottom:1px solid rgba(37,26,22,.07)}#editorLayer .head{padding:10px 12px 6px}.title{font:18px/1 'Archivo Black',sans-serif}.sub{margin-top:6px;font-size:12px;color:var(--muted);line-height:1.4}#editorLayer .title{font-size:14px}#editorLayer .sub{display:none}.body{min-height:0;overflow:auto;padding:0 18px 18px}#editorLayer .body{padding:0 12px 12px}.slider-row{display:flex;justify-content:space-between;gap:10px;align-items:center;margin:14px 0 8px;font-size:12px;font-weight:700;color:var(--muted);text-transform:uppercase;letter-spacing:.08em}#editorLayer .slider-row{margin:8px 0 6px;font-size:10px}.slider{width:100%;appearance:none;height:10px;border-radius:999px;background:rgba(37,26,22,.12);outline:none}.slider::-webkit-slider-thumb{appearance:none;width:28px;height:28px;border-radius:50%;background:var(--text);border:3px solid #fff;box-shadow:0 8px 18px rgba(37,26,22,.24)}
    .text-tools{display:grid;grid-template-columns:1fr 70px;gap:8px;margin-top:12px}#editorLayer .text-tools{margin-top:8px}.input{width:100%;border:1px solid var(--line);background:rgba(255,255,255,.9);border-radius:16px;padding:12px 13px}#editorLayer .input{border-radius:12px;padding:9px 10px}.color{padding:6px;height:46px}#editorLayer .color{height:38px}.picker{display:grid;gap:12px;padding-top:12px}.asset-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px;padding-bottom:2px}.asset{border:1px solid var(--line);background:linear-gradient(180deg,rgba(255,255,255,.98),rgba(244,235,225,.96));border-radius:20px;padding:8px;display:grid;gap:8px;justify-items:center;align-content:start;min-height:112px}.preview{width:100%;aspect-ratio:1;border-radius:16px;overflow:hidden;background:rgba(255,255,255,.74);border:1px solid rgba(37,26,22,.06);display:grid;place-items:center}.preview img{width:100%;height:100%;object-fit:cover}.preview.compact img{width:72%;height:72%;object-fit:contain}.preview.sw{background-position:center;background-repeat:no-repeat}.name{width:100%;font-size:11px;font-weight:700;line-height:1.2;text-align:center;color:var(--text)}.choices{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;margin-top:16px}.choice{border:1px solid var(--line);background:linear-gradient(180deg,rgba(255,255,255,.98),rgba(244,235,225,.96));border-radius:20px;padding:18px 14px;text-align:left}.choice strong{display:block;font-size:16px;line-height:1.1}.choice span{display:block;margin-top:8px;font-size:12px;line-height:1.45;color:var(--muted)}.danger{width:100%;margin-top:10px;border:none;border-radius:18px;padding:14px 16px;background:#221916;color:#fff;font-weight:700}#editorLayer .soft,#editorLayer .danger{border-radius:12px;padding:9px 10px;font-size:12px}#editorLayer .danger{margin-top:8px}
